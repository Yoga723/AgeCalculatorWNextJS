const Output = ({ currentAge, showData }: any) => {
  return (
    <div className="grid row-start-3 col-start-1 col-span-3 md:col-start-1 md:col-span-2 md:justify-start md:pl-12 md:pb-9 justify-center items-center p-3 pb-6 bg-white text-black">
      <p
        id="YEAR"
